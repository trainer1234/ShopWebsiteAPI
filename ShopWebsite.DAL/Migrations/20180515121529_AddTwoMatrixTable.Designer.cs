...
namespace ShopWebsite.DAL.Migrations
{
    ...
    [Migration("20180515121529_AddTwoMatrixTable")]
    partial class AddTwoMatrixTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopWebsite.DAL.Models.CustomerModels.ItemLatentFactorMatrix", b =>
                {
                    ...
                    b.Property<string>("UserItemPredictId");

                    b.HasKey("Id");

                    b.HasIndex("UserItemPredictId");
            ...
            modelBuilder.Entity("ShopWebsite.DAL.Models.CustomerModels.ItemLatentFactorMatrix", b =>
                {
                    b.HasOne("ShopWebsite.DAL.Models.CustomerModels.UserItemPredict", "UserItemPredict")
                        .WithMany("ItemLatentFactorMatrix")
                        .HasForeignKey("UserItemPredictId");
                });
            ...
            modelBuilder.Entity("ShopWebsite.DAL.Models.CustomerModels.UserLatentFactorMatrix", b =>
                {
                    b.HasOne("ShopWebsite.DAL.Models.CustomerModels.UserItemPredict", "UserItemPredict")
                        .WithMany("UserLatentFactorMatrix")
                        .HasForeignKey("UserItemPredictId");
                });
